...
public class TabButtonWidget extends ButtonWidget
{
	...
	public void renderButton(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
	{
		...
		GuiHelper.drawTextScaledShadow(pMatrixStack, message, this.x + 3, this.y + (this.height - 8) / 2, this.width - 6, j | MathHelper.ceil(this.alpha * 255.0F) << 24, TextAlignment.CENTER);
