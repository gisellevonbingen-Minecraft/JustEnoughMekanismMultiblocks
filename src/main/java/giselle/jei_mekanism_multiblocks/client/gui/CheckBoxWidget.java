...
public class CheckBoxWidget extends AbstractButton
{
	...
	public void renderButton(MatrixStack pMatrixStack, int pMouseX, int pMouseY, float pPartialTicks)
	{
		...
		GuiHelper.drawScaledText(pMatrixStack, this.getMessage(), this.x + checkerLength, this.y, this.width - checkerLength, 14737632 | MathHelper.ceil(this.alpha * 255.0F) << 24, true);
