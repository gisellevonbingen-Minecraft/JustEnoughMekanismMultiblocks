...
public class FissionLayoutScreen extends Screen
{
	...
	private static final Component COMPONENT_RESET = new TranslatableComponent("text.jei_mekanism_multiblocks.reset");
	private static final Component COMPONENT_CLEAR = new TranslatableComponent("text.jei_mekanism_multiblocks.clear");
	private static final Component COMPONENT_SAVE = new TranslatableComponent("text.jei_mekanism_multiblocks.save");
	private static final Component COMPONENT_CHECK = new TextComponent("✔");
	private static final Component COMPONENT_ERROR = new TextComponent("❌");
	private static final Component COMPONENT_JSON_SYNTAX_ERROR = new TranslatableComponent("text.jei_mekanism_multiblocks.json_syntax_error");
	private static final Component COMPONENT_IMPORT = new TranslatableComponent("text.jei_mekanism_multiblocks.import");
	private static final Component COMPONENT_IMPORT_FROM_CLIPBOARD = new TranslatableComponent("text.jei_mekanism_multiblocks.import_from_clipboard");
	private static final Component COMPONENT_IMPORTED_SUCCESSFULLY = new TranslatableComponent("text.jei_mekanism_multiblocks.imported_successfully");
	private static final Component COMPONENT_EXPORT = new TranslatableComponent("text.jei_mekanism_multiblocks.export");
	private static final Component COMPONENT_EXPORT_TO_CLIPBOARD = new TranslatableComponent("text.jei_mekanism_multiblocks.export_to_clipboard");
	private static final Component COMPONENT_EXPORTED_SUCCESSFULLY = new TranslatableComponent("text.jei_mekanism_multiblocks.exported_successfully");
	private static final Component COMPONENT_MAX_BURN_RATE = new TranslatableComponent("text.jei_mekanism_multiblocks.result.max_burn_rate");
	private static final Component COMPONENT_BOIL_EFFICIENCY = new TranslatableComponent("text.jei_mekanism_multiblocks.result.boil_efficiency");
	...
	public void render(PoseStack pPoseStack, int mouseX, int mouseY, float partialTick)
	{
		...
		for (int z = 0; z < layout.getLength(); z++)
		{
			...
			for (int x = 0; x < layout.getWidth(); x++)
			{
				...
				this.blit(pPoseStack, coordX, coordZ, u, v, CELL_WIDTH, CELL_HEIGHT);
				...
				if (!outer)
				{
					...
					if (pillar > 0)
					{
						Component text = PILLAR_COMPONENT_CACHE.computeIfAbsent(pillar, s -> new TextComponent(String.valueOf(s)));
						int textWidth = this.pillarTextWidthCache.computeIfAbsent(text, s -> this.font.width((Component) s));
						int textHeight = this.font.lineHeight;
						this.font.draw(pPoseStack, text, coordX + (CELL_WIDTH - textWidth) / 2, coordZ + (CELL_HEIGHT - textHeight), 0xFFFFFFFF);
					}
