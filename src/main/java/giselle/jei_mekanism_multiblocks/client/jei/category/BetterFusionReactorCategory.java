...
public class BetterFusionReactorCategory extends MultiblockCategory<BetterFusionReactorCategory.FusionReactorCategoryWidget>
{
	...
	{
		super(helper, BetterFusionReactor.rl("fusion_reactor"), FusionReactorCategoryWidget.class, Component.translatable("text.jei_mekanism_multiblocks.building.better_fusion_reactor"), BfrBlocks.FUSION_REACTOR_CONTROLLER.getItemStack());
	}
	...
	public static class FusionReactorCategoryWidget extends MultiblockWidget
	{
		...
		protected void collectOtherConfigs(Consumer<AbstractWidget> consumer)
		{
			...
			consumer.accept(this.useReactorGlassCheckBox = new CheckBoxWidget(0, 0, 0, 0, Component.translatable("text.jei_mekanism_multiblocks.specs.use_things", BfrBlocks.REACTOR_GLASS.getItemStack().getHoverName()), true));
		...
		protected void collectCost(ICostConsumer consumer)
		{
			...
			consumer.accept(new ItemStack(BfrBlocks.REACTOR_GLASS, reactorGlasses));
		}
