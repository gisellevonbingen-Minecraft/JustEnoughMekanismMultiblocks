...
public class BetterFusionReactorCategory extends MultiblockCategory<BetterFusionReactorCategory.FusionReactorCategoryWidget>
{
	...
	{
		super(helper, RECIPE_TYPE, new TranslatableComponent("text.jei_mekanism_multiblocks.building.better_fusion_reactor"), BfrBlocks.FUSION_REACTOR_CONTROLLER.getItemStack());
	}
	...
	public static class FusionReactorCategoryWidget extends MultiblockWidget
	{
		...
		protected void collectOtherConfigs(Consumer<AbstractWidget> consumer)
		{
			...
			consumer.accept(this.injectionRateWidget = new IntSliderWithButtons(0, 0, 0, 0, "text.jei_mekanism_multiblocks.specs.injection_rate", new Mod2IntSliderWidget(0, 0, 0, 0, TextComponent.EMPTY, 0, 0, FluidAttributes.BUCKET_VOLUME, 1)));
		...
		protected void collectResult(Consumer<AbstractWidget> consumer)
		{
			...
			ResultWidget requiredLaserEnergyWidget = new ResultWidget(new TranslatableComponent("text.jei_mekanism_multiblocks.result.required_laser_energy"), EnergyDisplay.of(requiredLaserEnergy).getTextComponent());
