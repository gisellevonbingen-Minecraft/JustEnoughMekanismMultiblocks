...
public class EvaporationPlantCategory extends MultiblockCategory<EvaporationPlantCategory.EvaporationPlantWidget>
{
	...
	{
		super(helper, RECIPE_TYPE, MekanismLang.EVAPORATION_PLANT.translate(), new ItemStack(MekanismBlocks.THERMAL_EVAPORATION_CONTROLLER));
	}
	...
	public static class EvaporationPlantWidget extends MultiblockWidget
	{
		...
		public long getRequiredHeaterEnergy(double ambientTemp)
		{
			...
			return (long) Math.ceil(ResistiveHeaterCategory.getHeatTransferableEnergy(ambientTemp, heat, HeatAPI.DEFAULT_INVERSE_CONDUCTION));
		}
