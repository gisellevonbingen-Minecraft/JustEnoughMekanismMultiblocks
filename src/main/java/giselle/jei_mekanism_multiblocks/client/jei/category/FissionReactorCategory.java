...
public class FissionReactorCategory extends MultiblockCategory<FissionReactorCategory.FissionReactorCategoryWidget>
{
	...
	public static class FissionReactorCategoryWidget extends MultiblockWidget
	{
		...
		public void createStableTempWidgets(Consumer<Widget> consumer, long toBurn)
		{
		...
		public void createStableTempWidget(Consumer<Widget> consumer, ITextComponent with, long toBurn, Coolant coolant)
		{
			this.createStableTempWidget(consumer, with, toBurn, coolant.getConductivity(), coolant.getThermalEnthalpy());
		}

		public void createStableTempWidget(Consumer<Widget> consumer, ITextComponent with, long toBurn, double conductivity, double thermalEnthalpy)
		{
