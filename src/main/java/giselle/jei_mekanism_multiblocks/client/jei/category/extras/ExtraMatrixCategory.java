...
public class ExtraMatrixCategory extends MultiblockCategory<ExtraMatrixCategory.MatrixWidget>
{
	...
	{
		super(helper, RECIPE_TYPE, Component.translatable("text.jei_mekanism_multiblocks.building.extra_matrix"), ExtraBlocks.REINFORCED_INDUCTION_PORT.getItemStack());
	}
